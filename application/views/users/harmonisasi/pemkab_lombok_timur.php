                            ...
                            foreach ($query->result() as $baris):?>
                                <tr>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/h/<?php echo hashids_encrypt($baris->id_berita); ?>/pemkab_lombok_timur"
                                           class="btn btn-danger btn-xs"
                                           title="Hapus Dokumen" onclick="return confirm('Anda yakin?');">
                                            <i class="fa fa-trash-o"></i>
                                        </a>

                                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/e/<?php echo hashids_encrypt($baris->id_berita); ?>/pemkab_lombok_timur"
