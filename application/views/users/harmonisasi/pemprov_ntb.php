                                    ...
                                    <td align="center">
                                        <a href="<?php echo base_url($baris->lamp_surat_undangan);?>"
                                           ...
                                           download="">
                                            ...
                                            <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/h/<?php echo hashids_encrypt($baris->id_berita); ?>/pemprov_ntb"
                                               class="btn btn-danger btn-xs"
                                               title="Hapus Dokumen" onclick="return confirm('Anda yakinz?');">
                                                <i class="fa fa-trash-o"></i>
                                            </a>

                                        <a href="<?php echo $link1; ?>/<?php echo $link2; ?>/e/<?php echo hashids_encrypt($baris->id_berita); ?>/pemprov_ntb"
